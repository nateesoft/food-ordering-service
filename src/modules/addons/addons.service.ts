...
export class AddonsService {
  ...
  // Add-ons
  async findAllAddOns(category?: string, isActive?: boolean) {
    const where: any = {};
  ...
  // Add-on Groups
  async findAllAddOnGroups(category?: string, isActive?: boolean) {
    const where: any = {};
  ...
  async createAddOnGroup(createAddOnGroupDto: CreateAddOnGroupDto) {
